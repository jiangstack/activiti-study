...
public class Ch2StudentLeave2 {
    ...
    public void deploy(){
        ...
        Deployment deploy = processEngine.getRepositoryService()   //获取部署相关service
                ...
                .addClasspathResource("bpmn/studentLeave2.bpmn") //加载资源
                .name("学生请假流程2")
                .deploy();//部署
    ...
    public void start() throws Exception{
        ...
        ProcessInstance myFirstProcess =
                runtimeService.startProcessInstanceByKey("studentLeave2");  //通过key得到流程实例
...
//        vars.put("state","im");
        TaskService taskService = processEngine.getTaskService();
        taskService.complete("25002",vars);
    }
